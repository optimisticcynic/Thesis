...
\end{figure}
This decay process includes a neutrino, which is undetectable by the detector, complicating the mass measurement of the W. In order to directly measure the mass of a particle, the properties of the decay products must be known, either through direct measurement or by other means. It would be possible to reconstruct the energy of the neutrino by measuring the missing momentum, however the momentum of all other particles in the interaction must be known. Although the momentum of the protons are well known, each quark carries only a fraction of it, and not a constant fraction as the quarks are in constant motion inside the proton. This is further complicated since the leftover quarks, ones not involved in creating the W, are capable of going down the beam pipe, and not interacting with the detector, therefore it is impossible to measure their momentum. 
